...
test("Deve criar um pedido com três itens e calcular o frete minímo", function () {
    const order = new Order("935.411.347-80");
    order.addItem(new Item(1, "Instrumentos Musicais", "Cabo", 30, new Dimension(10, 10, 10), 0.9), 1);
    const total = order.getTotal();
